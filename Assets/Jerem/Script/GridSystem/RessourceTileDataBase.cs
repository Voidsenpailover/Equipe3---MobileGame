...
public class RessourceTileDataBase: MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        {
            Resources.Load<TileBase>(_roadTilePath + "MainRoad(blank)"),
            Resources.Load<TileBase>(_roadTilePath + "MainRoadForward(blank)"),
            Resources.Load<TileBase>(_roadTilePath + "MainRoadTurn(blank)")
        };
